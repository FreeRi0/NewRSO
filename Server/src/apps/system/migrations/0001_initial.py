# Generated by Django 4.2.4 on 2023-11-14 08:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commander', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='commander', to='system.profile', verbose_name='Командир')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Detachment',
            fields=[
                ('unit_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='system.unit')),
                ('area', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='system.area', verbose_name='Направление')),
            ],
            options={
                'verbose_name': 'Отряд',
        ...
        migrations.AddField(
            model_name='profile',
            name='fact_region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='fact', to='system.region', verbose_name='Регион проживания'),
        ),
        migrations.AddField(
            model_name='profile',
            name='reg_region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='reg', to='system.region', verbose_name='Регион прописки'),
        ),
        migrations.AddField(
            model_name='profile',
            name='region',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='system.region', verbose_name='Регион ОО'),
        ),
        migrations.AddField(
            model_name='profile',
            name='user',
        ...
        migrations.AddField(
            model_name='profile',
            name='detachment',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='system.detachment', verbose_name='Отряд'),
        ),
    ]

...
const o = {}, i = e => new Promise((t => {
    ...
    P = () => w(r["validation-message"]), L = () => v(`.${r.actions} .${r.confirm}`),
    ...
    I = () => {
        ...
        const t = e.querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])'),
            n = Array.from(t).sort(((e, t) => {
                const n = parseInt(e.getAttribute("tabindex") || "0"), o = parseInt(t.getAttribute("tabindex") || "0");
    ...
    se = () => {
        ...
        o.appendChild(n), (e => {
            ...
            const e = C(), t = W(e, r.input), n = W(e, r.file), o = e.querySelector(`.${r.range} input`),
                i = e.querySelector(`.${r.range} output`), s = W(e, r.select), a = e.querySelector(`.${r.checkbox} input`),
                l = W(e, r.textarea);
...
const ke = (e, t) => {
...
}, Le = e => `<div class="${r["icon-content"]}">${e}</div>`, xe = (e, t) => {
    const n = t.showClass || {};
    ...
    ((e, t) => {
        ...
        if (n && o) {
            ...
            Y(o, "padding", t.padding), t.color && (o.style.color = t.color), t.background && (o.style.background = t.background), J(P()), xe(o, t)
        }
    })(0, t), pe(0, t), ((e, t) => {
        const n = $();
        if (!n) return;
...
}, je = Object.freeze({cancel: "cancel", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer"}), He = e => {
...
const ot = e => {
        ...
        const n = O(), o = S();
        n && o && (!t && ee(L()) && (t = L()), Z(n), t && (J(t), o.setAttribute("data-button-to-replace", t.className), n.insertBefore(o, t)), z([e, n], r.loading))
    ...
    mt = (e, t) => {
        ...
        const o = e => {
            "select" === t.input ? function (e, t, n) {
                ...
                if (!o) return;
                t.forEach((e => {
                    const t = e[0], i = e[1], s = document.createElement("input"), a = document.createElement("label");
        ...
        g(t.inputOptions) || b(t.inputOptions) ? (lt(L()), f(t.inputOptions).then((t => {
            e.hideLoading(), o(t)
...
const Et = e => {
    ...
    t.length ? Z(t[0], "inline-block") : ee(L()) || ee(T()) || ee(x()) || J(e.actions)
};
...
const jt = {
    ...
    qt = e => Object.prototype.hasOwnProperty.call(jt, e), Vt = e => -1 !== Ht.indexOf(e), Nt = e => It[e], _t = e => {
...
var Pn = (e, t) => /^[a-zA-Z0-9.+_'-]+@[a-zA-Z0-9.-]+\.[a-zA-Z0-9-]+$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid email address"),
    Ln = (e, t) => /^https?:\/\/(www\.)?[-a-zA-Z0-9@:%._+~#=]{1,256}\.[a-z]{2,63}\b([-a-zA-Z0-9@:%_+.~#?&/=]*)$/.test(e) ? Promise.resolve() : Promise.resolve(t || "Invalid URL");

function xn(e) {
    !function (e) {
        e.inputValidator || ("email" === e.input && (e.inputValidator = Pn), "url" === e.input && (e.inputValidator = Ln))
...
class On {
    ...
    _main(e) {
        ...
        const n = jn(e, t);
        xn(n), Object.freeze(n), o.timeout && (o.timeout.stop(), delete o.timeout), clearTimeout(o.restoreFocusTimeout);
        const i = Hn(Tn);
...
const Mn = (e, t, n) => new Promise(((i, s) => {
        ...
        Ue.swalPromiseResolve.set(e, i), Ue.swalPromiseReject.set(e, s), t.confirmButton.onclick = () => {
            ...
            "select" === t.input || "radio" === t.input ? mt(e, t) : ["text", "email", "number", "tel", "textarea"].some((e => e === t.input)) && (g(t.inputValue) || b(t.inputValue)) && (lt(L()), ht(e, t))
...
On.prototype.disableButtons = xt, On.prototype.enableButtons = Lt, On.prototype.getInput = Bt, On.prototype.disableInput = St, On.prototype.enableInput = Tt, On.prototype.hideLoading = kt, On.prototype.disableLoading = kt, On.prototype.showValidationMessage = Ot, On.prototype.resetValidationMessage = Mt, On.prototype.close = et, On.prototype.closePopup = et, On.prototype.closeModal = et, On.prototype.closeToast = et, On.prototype.rejectPromise = nt, On.prototype.update = Ut, On.prototype._destroy = Kt, Object.assign(On, un), Object.keys(Jt).forEach((e => {
    On[e] = function () {

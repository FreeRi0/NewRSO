...
const uploadPhoto = async () => {
    ...
    // formData.append('photo3', userPhotos.value);
    // formData.append('photo4', userPhotos.value);
...
const updatePhoto = async () => {
    ...
    // fd.append('photo4', userPhotos.value);
    dialog.value = true;

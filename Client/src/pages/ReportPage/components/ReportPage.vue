                ...
                <v-expansion-panel>
                    ...
                    <v-expansion-panel-text class="form__inner-content">
                        <div class="form__field-group">
                            ...
                            <span>ОДНОВРЕМЕННО МОЖНО ОТПРАВИТЬ ДАННЫЕ ПО ПЯТИ
                                УЧАСТНИКАМ.</span>
                            <div class="form__field-group-bottom">
                                <div class="form__field-group-bottom-btn">
                                    <v-progress-circular class="circleLoader" v-if="isLoading" indeterminate
                            ...
                            <div class="form__field-group-bottom">
                                <div class="form__field-group-bottom-btn">
                                    <v-progress-circular class="circleLoader" v-if="isLoading" indeterminate
                                        color="blue"></v-progress-circular>
                                    <Button v-if="!is_regional_commander" type="button"
                                        :disabled="report[20].disabledBtn" class="form__button form__button-color"
                                        label="Отправить данные на верификацию" size="large"
...
const deleteBlock = (index, sectionIndex, nameSection) => {
    ...
    if (sectionIndex === 5) {
        ...
        if (sectionData.length < 5) report.value[sectionIndex].hidden_btn = false;
    }
};

                            ...
                            <div class="form-container">
                                <div class="form-col">
                                    ...
                                    <div class="form__field">
                                        ...
                                        <div class="form__counter">
                                            {{
                                                maininfo.conference_link.length
                                            }}/60
                                        </div>
                                    </div>
                                    <div class="form__field">
                                ...
                                <div class="form-col">
                                    <div class="form__field">
                                        <label
                                            class="form__label"
                                            for="address-hq"
                                            >Адрес проведения (если мероприятияе
                                            формата офлайн)
                                            <sup class="valid-red"
                                                >*</sup
                                            ></label
                ...
                <v-expansion-panel value="panelFour">
                    ...
                    <v-expansion-panel-text class="form__inner-content">
                        <div class="form__field-group">
                            ...
                            >
                                <div
                                    v-if="organizer.organizerBtnClose"
                                    class="organizer__close"
                                >
                                    <svg
                                        @click="
                                            () => {
    ...
    getAction(id)
        .then((resp) => {
            ...
            maininfo.value.org_central_headquarter =
                resp.data.org_central_headquarter || '';
            maininfo.value.org_district_headquarter =
                resp.data.org_district_headquarter || '';
            maininfo.value.org_regional_headquarter =
                resp.data.org_regional_headquarter || '';
            maininfo.value.org_local_headquarter =
                resp.data.org_local_headquarter || '';
            maininfo.value.org_educational_headquarter =
                resp.data.org_educational_headquarter || '';
...
const cropImage = () => {
    if (cropper.value) {
        ...
        canvas.toBlob((blob) => {
            maininfo.value.banner = new File([blob], 'banner.jpg', {
                type: 'image/jpeg',
            });
        }, 'image/jpeg');
    }

    ...
    <div>
        <div class="container">
            <h1 class="title title--mb">
                Отчет о&nbsp;деятельности регионального отделения РСО
                за&nbsp;2024&nbsp;год. Часть&nbsp;2
            </h1>
                ...
                <v-expansion-panels>
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="isErrorPanel.first ? 'visible-error' : ''"
                        >
                            1. Численность членов РО&nbsp;РСО
                            в&nbsp;соответствии с&nbsp;объемом уплаченных
                            членских взносов
                        </v-expansion-panel-title>
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title>
                            2. Отношение численности членов РО&nbsp;РСО
                            к&nbsp;численности студентов очной формы обучения
                            субъекта Российской Федерации, обучающихся
                            ...
                            и&nbsp;частных образовательных организациях, включая
                            филиалы (исключения&nbsp;&mdash; учебные заведения
                            специальных ведомств, проводящих обучение
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title>
                            3. Прирост численности членов РО&nbsp;РСО
                            относительно количества членов в&nbsp;соответствии
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="isErrorPanel.fourth ? 'visible-error' : ''"
                        >
                            4. Организация всероссийских (международных),
                            окружных и&nbsp;межрегиональных мероприятий
                            и&nbsp;проектов (слеты, школы, фестивали, турниры
                            и&nbsp;прочие)
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <fourth-panel
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="isErrorPanel.fifth ? 'visible-error' : ''"
                        >
                            5. Организация всероссийских (международных)
                            (организатор&nbsp;&mdash; региональное отделение
                            РСО), окружных и&nbsp;межрегиональных трудовых
                            проектов в&nbsp;соответствии с&nbsp;Положением
                            об&nbsp;организации трудовых проектов РСО
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <fifth-panel
                                :districtExpert="districtExpert"
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="
                                Object.values(isErrorPanel.six).some(
                            ...
                            "
                        >
                            6. Участие бойцов студенческих отрядов РО&nbsp;РСО
                            во&nbsp;всероссийских (международных) мероприятиях
                            и&nbsp;проектах (в&nbsp;том числе и&nbsp;трудовых)
                            &laquo;К&raquo;
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <sixth-panel
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="
                                Object.values(isErrorPanel.seventh).some(
                                    (item) => item.error === true,
                                )
                                    ? 'visible-error'
                                    : ''
                            "
                        >
                            7. Победители студенческих отрядов РО&nbsp;РСО
                            во&nbsp;всероссийских (международных) проектах
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title>
                            8. Количество упоминаний в&nbsp;СМИ о&nbsp;прошедших
                            творческих, добровольческих и&nbsp;патриотических
                            мероприятиях и&nbsp;трудовых проектах,
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="
                                Object.values(isErrorPanel.ninth).some(
                                    (item) => item.error === true,
                                )
                                    ? 'visible-error'
                                    : ''
                            "
                        >
                            9. Организация обязательных общесистемных
                            мероприятий РСО на&nbsp;региональном уровне
                            &laquo;К&raquo;
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <ninth-panel
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="isErrorPanel.tenth ? 'visible-error' : ''"
                        >
                            10. Организация РО&nbsp;РСО всероссийских
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="
                                isErrorPanel.eleventh ? 'visible-error' : ''
                            "
                        >
                            11. Активность РО&nbsp;РСО в&nbsp;социальных сетях
                            &laquo;К&raquo;
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <eleventh-panel
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="isErrorPanel.twelfth ? 'visible-error' : ''"
                        >
                            12. Объем средств, собранных бойцами РО&nbsp;РСО
                            во&nbsp;Всероссийском дне ударного труда
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <twelfth-panel
                                :districtExpert="districtExpert"
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="
                                isErrorPanel.thirteenth ? 'visible-error' : ''
                            "
                        >
                            13. Охват членов РО&nbsp;РСО, принявших участие
                            во&nbsp;Всероссийском дне ударного труда
                            &laquo;К&raquo;
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title>
                            14. Отношение объема средств, собранных бойцами
                            РО&nbsp;РСО во&nbsp;Всероссийском дне ударного труда
                            к&nbsp;количеству членов РО&nbsp;РСО, принявших
                            участие во&nbsp;Всероссийском дне ударного труда
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <calculated-panel
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title>
                            ...
                            соблюдение условий охраны труда на&nbsp;трудовых
                            проектах РСО, наличие проблемной неурегулированной
                            задолженности по&nbsp;выплате заработной платы перед
                            бойцами РСО за&nbsp;трудовой семестр предыдущего
                            года, отсутствие отчислений от&nbsp;членских взносов
                            в&nbsp;Центральный штаб, исполнение решений
                            Центральных руководящих органов РСО, наличие
                            ежегодного акта проверки КРК РО&nbsp;РСО
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <calculated-panel
                                text="Показатель рассчитывается автоматически на&nbsp;основе данных, предоставленных Аппаратом РСО."
                    ...
                    <v-expansion-panel>
                        <v-expansion-panel-title
                            :class="
                                isErrorPanel.sixteenth ? 'visible-error' : ''
                            "
                        >
                            16. Победители всероссийских (международных),
                            окружных и&nbsp;межрегиональных трудовых проектов
                    ...
                    <v-expansion-panel>
                        ...
                        <v-expansion-panel-text>
                            <seventeenth-panel
                                ...
                                :is-sent="reportData.sixteenth.is_sent"
                            />
                        </v-expansion-panel-text>
                    </v-expansion-panel>
                    <v-expansion-panel>
                        <v-expansion-panel-title>
                            18. Количество научных работ и&nbsp;публикаций
                            по&nbsp;теме&nbsp;СО, выпущенных в&nbsp;текущем году
                        </v-expansion-panel-title>
                        <v-expansion-panel-text>
                            <eighteenth-panel
                                :districtExpert="districtExpert"
...
const getItems = async (number) => {
    try {
        const response = await HTTP.get(
            `regional_competitions/reports/event_names/r${number}-event-names/`,
        );
        switch (number) {
            case 6:
...
const getMultiplyData = async (isExpert, reportId) => {
        ...
        try {
            if (!isExpert) {
                return {
                    id: item.id,
                    data: (
                        await reportPartTwoService.getMultipleReport(
                            '6',
                            item.id,
                        )
                    ).data,
                ...
                const reportData = (
                    await reportPartTwoService.getMultipleReportDH(
                        '6',
                        item.id,
                        reportId,
                    )
                ).data;
                return reportData.is_sent
                    ? { id: item.id, data: reportData }
                    : null;
            }
        } catch (error) {
    ...
    const [sixDataResults, seventhDataResults, ninthDataResults] =
        await Promise.all([
    ...
    ninthDataResults.forEach((result) => {
        if (districtExpert.value || centralExpert.value) {
            ...
            reportData.value.ninthDH[result.id] = result.data;
        }
        reportData.value.ninth[result.id] = result.data;
    });
};
const getReportData = async (reportId) => {
    try {
        if (centralExpert.value || districtExpert.value) {
            ...
            reportData.value.eleventh = (
                await reportPartTwoService.getReportDH('11', reportId)
            ).data;
            ...
            try {
                reportData.value.fifth = (
                    await reportPartTwoService.getReport('5')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            ...
            try {
                reportData.value.tenth.first = (
                    await reportPartTwoService.getMultipleReport('10', '1')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            try {
                reportData.value.tenth.second = (
                    await reportPartTwoService.getMultipleReport('10', '2')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            try {
                reportData.value.eleventh = (
                    await reportPartTwoService.getReport('11')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            try {
                reportData.value.twelfth = (
                    await reportPartTwoService.getReport('12')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            try {
                reportData.value.thirteenth = (
                    await reportPartTwoService.getReport('13')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            try {
                reportData.value.sixteenth = (
                    await reportPartTwoService.getReport('16')
                ).data;
            ...
            try {
                reportData.value.seventeenth = (
                    await reportPartTwoService.getReport('17')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            try {
                reportData.value.eighteenth = (
                    await reportPartTwoService.getReport('18')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
            try {
                reportData.value.nineteenth = (
                    await reportPartTwoService.getReport('19')
                ).data;
            } catch (e) {
                console.log(e.message);
            }
...
const setDataDH = (data, panel, number) => {
    switch (panel) {
        case 6:
            ...
            break;
        case 9:
            reportData.value.ninthDH[number] = data;
            break;
    }
};
...
const filterPanelsData = () => {
    ...
    for (let i in reportData.value.seventh) {
        if (
            reportData.value.seventh[i].prize_place !== 'Нет' &&
            Object.keys(reportData.value.seventh[i]).length !== 0
        ) {
...
const sendReport = async () => {
    ...
    if (checkEmptyFields(reportData.value)) {
        try {
            const { filteredSix, filteredSeventh, filteredNinth } =
                filterPanelsData();
            if (!reportData.value.first.is_sent) {
                await reportPartTwoService.sendReport(
                    reportData.value.first,
                    '1',
                );
            }
            ...
            for (let item in filteredSix) {
                if (filteredSix[item].is_sent === false) {
                    await reportPartTwoService.sendReportWithSlash(
                        filteredSix,
                        '6',
                    );
                }
...
const checkEmptyFields = (data) => {
    ...
    for (let item in filteredSeventh) {
        if (
            !(
                filteredSeventh[item]?.links?.length &&
                filteredSeventh[item].document &&
                filteredSeventh[item].comment
            )
        ) {
    ...
    if (
        !data.eleventh ||
        !(data.eleventh.participants_number && data.eleventh.scan_file)
    ) {
    ...
    if (
        !data.twelfth ||
        !(data.twelfth.amount_of_money && data.twelfth.scan_file)
    ) {
    ...
    if (
        !data.thirteenth ||
        !(data.thirteenth.number_of_members && data.thirteenth.scan_file)
    ) {
    ...
    if (data.sixteenth) {
        for (let project of data.sixteenth.projects) {
            if (
                !(project.name && project.regulations && data.sixteenth.comment)
            ) {

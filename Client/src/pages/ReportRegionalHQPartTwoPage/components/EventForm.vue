...
const sixPanelDataCH = ref(reportStore.reportDataCH?.six?.[props.event.id] ? reportStore.reportDataCH.six[props.event.id] : { number_of_members: null, hq_members_count: null })
const eventData = ref({
    number_of_members: 0,
    links: [{ link: '' }],
    comment: '',

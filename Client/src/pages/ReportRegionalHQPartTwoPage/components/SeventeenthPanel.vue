<template>
  <div
    ...
    v-if="isSent && !seventeenthPanelData.scan_file && !seventeenthPanelData.comment"
  >
  ...
  <div v-else class="form__field-group report__field-group">
    ...
    <div
      class="report__fieldset report__file-input"
      v-if="
    ...
    >
      <label class="form__label report__label" for="scan_file">
        ...
        <span v-if="isSent && seventeenthPanelData.scan_file"> Документ </span>
      </label>
      <InputReport
...
const templateLinkAddress =
  import.meta.env.VITE_BACKEND_BASE_URL + `regional_competitions_2025/export-template/`;

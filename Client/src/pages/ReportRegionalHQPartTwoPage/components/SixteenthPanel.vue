<template>
  ...
  >
    <div>
      <p class="form__label">Наличие трудового проекта, в котором ЛСО РО одержал победу <sup class="valid-red">*</sup></p>
    ...
    <div v-for="(project, index) in projects" :key="index">
      <div style="display: flex; justify-content: space-between; margin-top: 40px;">
        <div>
          <label
              class="form__label"
              for="9"
          >Наименование трудового проекта, в котором ЛСО РО одержал победу <sup class="valid-red">*</sup></label>
          <InputReport
      ...
      <div>
        <div style="display: flex;">
          ...
          <div style="margin-left: 40px;">
            <p
                class="form__label"
            >Масштаб проекта <sup class="valid-red">*</sup></p>
            <div style="display: flex;">
              <input
      ...
      <div>
        <p
            class="form__label"
        >Ссылка на группу проекта в социальных сетях <sup class="valid-red">*</sup></p>
        <div style="display: flex; margin-bottom: 5px; align-items: center" v-for="(link, i) in projects[index].links" :key="i">
          <InputReport
      ...
      <v-tabs-window v-model="tab">
        <v-tabs-window-item value="one">
          <div class="form__field-group">
            <div class="form__field">
              <p
                  class="form__label"
              >Наличие трудового проекта, в котором ЛСО РО одержал победу <sup class="valid-red">*</sup></p>
              <div style="display: flex;">
                <div style="display: flex; align-items: center">
                  <InputReport
                      id="2"
            ...
            <div>
              <label
                  class="form__label"
                  for="6"
              >Ссылка на группу проекта в социальных сетях <sup class="valid-red">*</sup></label>
              <InputReport
                  id="6"
                  name="6"
                  class="form__input"
        ...
        <v-tabs-window-item value="three">
          <div class="form__field-group report-table">
            ...
            <label
                class="form__label"
            >Масштаб проекта <sup class="valid-red">*</sup></label>
            <v-table>
              <tbody>
              <tr class="report-table__tr">

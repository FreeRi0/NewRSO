            ...
            <v-expansion-panel
                ...
                >
                    <div class="title_wrap">
                        ...
                        <div class="title_wrap__items">
                            <p class="form__title month" v-if="item.month">
                                {{ item.month }}
                            </p>
                            <p class="form__title city" v-if="item.city">
                                {{ item.city }}
                            </p>
                        </div>
                ...
                ><v-expansion-panel-text>
                    <SeventhPanelForm
                        ...
                        @getId="getId($event)"
                        :data="sixPanelData"
                        :dataDH="sixPanelDataDH"
                        :dataCH="sixPanelDataCH"
                        :is-sent-six="isSentSix"
                        ...
                        :title="item"
                    >
                    </SeventhPanelForm> </v-expansion-panel-text
            ></v-expansion-panel>
        </v-expansion-panels>
    </v-card>
</template>

<template>
  <v-card-text class="panel-card-text">
    <v-tabs-window
      v-if="
        !(
          props.isCentralHeadquarterCommander ||
          props.isDistrictHeadquarterCommander ||
          reportStore.isReportReject?.six[props.sixId] ||
          reportStore.isReportReject?.ninth[props.ninthId] ||
    ...
    >
      ...
      <div v-if="props.panel_number == 6" class="form__field-group group-seventh">
        ...
        <div class="form__field places">
          <p class="form__label">
            Количество человек, принимавших участие в мероприятии
            <sup class="valid-red">*</sup>
          </p>
          <InputReport
            @focusout="focusOut"
            v-model:value="sixPanelData.number_of_members"
            :disabled="isSentSix"
        ...
        <div class="form__field">
          ...
          <div
            class="form__wrapper"
            v-for="(item, index) in sixPanelData.links"
            :key="index"
          >
            <InputReport
              ...
              :disabled="
                isSentSix ||
                sixPanelData.number_of_members == 0 ||
                sixPanelData.number_of_members === null
              "
              :maxlength="200"
              name="link"
            ...
            <div v-if="!isSentSix && sixPanelData.number_of_members > 0">
              ...
              <div class="add_link" @click="deleteLink(6)" v-else>Удалить поле ввода</div>
            </div>
          </div>
        </div>
        <div class="form__field">
          ...
          <TextareaReport
            v-model:value="sixPanelData.comment"
            id="comment"
            name="comment"
            :rows="1"
            autoResize
      ...
      <div v-else-if="props.panel_number == 10" class="form__field-group group-seventh">
        <div class="d-flex justify-space-between">
          <div class="title_wrap">
            <p class="form__title">{{ props.title.name }}</p>
            <div class="title_wrap__items">
              <p class="form__title month" v-if="props.title.month">
                {{ props.title.month }}
              </p>
              <p class="form__title city" v-if="props.title.city">
                {{ props.title.city }}
              </p>
            </div>
          </div>
        ...
        <div class="form__field places mt-4">
          <p class="form__label">Проведение мероприятия <sup class="valid-red">*</sup></p>
        ...
        <div class="report__fieldset report__fieldset--right-block">
          ...
          <InputReport
            v-if="!ninthPanelData.document"
            isFile
            type="file"
            accept=".jpg, .jpeg, .png, .pdf"
            id="scan_file"
            :is-error-panel="isErrorPanel"
            v-model:value="ninthPanelData.document"
            name="scan_file"
            width="100%"
            :disabled="isSentNinth || ninthPanelData.event_happened === false"
            height="auto"
            @change="uploadFile($event, 10)"
          />
          <div
            v-else-if="
              ninthPanelData.document && typeof ninthPanelData.document !== 'string'
            "
            class="text-center"
          >
        ...
        <div class="form__field">
          <label class="form__label mt-4" for="14"
            >Ссылка на социальные сети/ электронные СМИ, подтверждающая проведение акции
            <sup class="valid-red">*</sup></label
          >

          <div
            class="form__wrapper"
            v-for="(item, index) in ninthPanelData.links"
            :key="index"
          >
            <InputReport
              @focusout="focusOut"
            ...
            <div v-if="!isSentNinth && ninthPanelData.event_happened === true">
              ...
              <div class="add_link" @click="deleteLink(10)" v-else>
                Удалить поле ввода
              </div>
            </div>
          </div>
        ...
        <div class="form__field">
          <label class="form__label" for="14">Комментарий</label>
          <TextareaReport
            v-model:value="ninthPanelData.comment"
            id="comment"
            name="comment"
            :rows="1"
            autoResize
    ...
    >
      <template v-slot:firstTab>
        ...
        <div v-if="props.panel_number == 6" class="group-seventh">
          ...
          <div class="form__field" v-if="sixPanelData?.links?.length > 0">
            <label class="form__label" for="14"
              >Ссылка на социальные сети/ электронные СМИ, подтверждающая участие в
              мероприятии <sup class="valid-red">*</sup></label
            >
        ...
        <div v-else-if="props.panel_number == 10" class="group-seventh">
          <div class="d-flex justify-space-between">
            <div class="title_wrap">
              <p class="form__title">{{ props.title.name }}</p>
            </div>
          ...
          <div class="form__field places mt-4">
            ...
            <div v-else class="places_wrap one_place">
              <input
                :id="12"
                :value="ninthPanelData.event_happened"
                @focusout="focusOut"
                :name="12"
                :disabled="
                  props.tab === 'Просмотр отправленного отчета' &&
                ...
                "
                :checked="
                  ninthPanelData.event_happened === true ||
              ...
              />
              <label
                v-if="ninthPanelData.event_happened === true"
                class="places_item_label"
                :for="id"
                >Да</label
              >
              <label
                v-else-if="ninthPanelData.event_happened === false"
                class="places_item_label"
                :for="id"
                >Нет</label
              >
          ...
          >
            ...
            <InputReport
              ...
              @change="uploadFile($event, 10)"
              v-if="
                !ninthPanelData.document && props.tab !== 'Просмотр отправленного отчета'
              "
              isFile
              type="file"
              accept=".jpg, .jpeg, .png, .pdf"
          ...
          <div
            class="form__field"
            v-if="ninthPanelData.comment !== null || ninthPanelData.comment !== ''"
          >
            <label class="form__label" for="14">Комментарий</label>
            <TextareaReport
              @focusout="focusOut"
      ...
      <template v-slot:secondTab>
        ...
        <div v-if="props.panel_number == 6" class="group-seventh">
          ...
          <div class="form__field places">
            ...
            <InputReport
              v-model:value="sixPanelDataDH.number_of_members"
              placeholder="Введите число"
              id="15"
              name="14"
              class="form__input number_input"
          ...
          <CommentFileComponent
            v-model:value="sixPanelDataDH.comment"
            :is-error-panel="isErrorPanel"
            :disabled="
              props.isCentralHeadquarterCommander ||
              !(
        ...
        <div v-else-if="props.panel_number == 10" class="group-seventh">
          ...
          <CommentFileComponent
            v-model:value="ninthPanelDataDH.comment"
      ...
      <template v-slot:thirdTab>
        ...
        <div v-if="props.panel_number == 6" class="group-seventh">
          ...
          <ReportTable
            label="Количество человек, принявших участие в мероприятии"
            class="mb-4"
            name="sixPanelData.number_of_members"
            :dataRH="sixPanelData.number_of_members"
            :dataDH="sixPanelDataDH.number_of_members"
            v-model:value="sixPanelDataCH.number_of_members"
            :maxlength="10"
            :min="0"
            :max="2147483647"
            :is-error-panel="isErrorPanel"
            :disabled="
              !(
                props.isDistrictHeadquarterCommander ||
                props.isCentralHeadquarterCommander
              ) || reportStore.reportForCheckCH.six[props.sixId]?.verified_by_chq
            "
          >
          </ReportTable>

          <CommentFileComponent
            v-model:value="sixPanelDataCH.comment"
            name="sixPanelDataCH.comment"
            :is-six="true"
            :CH="true"
            :is-error-panel="isErrorPanel"
            :disabled="
          ...
          <div>
            <v-checkbox
              ...
              v-model="reportStore.returnReport.six[props.sixId]"
              @change="returnForReviewSix"
              :disabled="
                !(
                  props.isDistrictHeadquarterCommander ||
                  props.isCentralHeadquarterCommander
        ...
        <div
          v-else-if="props.panel_number == 10"
          class="group-seventh form__field-group-panel-ninth"
        >
          <div class="d-flex justify-space-between">
            <div class="title_wrap">
              <p class="form__title">{{ props.title.name }}</p>
          ...
          <ReportTable
            label="Проведение мероприятия "
            name="ninthPanelData.event_happened"
            :dataRH="ninthPanelData.event_happened"
            :is-ninth-panel="true"
            :dataDH="ninthPanelDataDH.event_happened"
          ...
          <CommentFileComponent
            v-model:value="ninthPanelDataCH.comment"
            name="ninthPanelDataCH.comment"
            @change="uploadFile($event, 10)"
            @click="deleteFile(10)"
            :CH="true"
            :file="fileCH.name"
          ...
          <div>
            <v-checkbox
              v-if="!reportStore.isAllReportsVerifiedByCH"
              v-model="reportStore.returnReport.ninth[props.ninthId]"
...
const uploadFile = (event, number) => {
  ...
  if (number === 10) {
    if (event.target.files) {
      fileValidate(event.target.files[0], 10, isErrorFile);
      if (isErrorFile.value) {
        console.log("error");
        scanFile.value = event.target.files[0];
    ...
    if (props.panel_number == 6) {
      if (props.isDistrictHeadquarterCommander || props.isCentralHeadquarterCommander) {
        ...
        if (reportStore.reportDataDH.six[props.sixId]) {
          sixPanelDataDH.value.comment =
            reportStore.reportDataDH.six[props.sixId].comment;
          sixPanelDataDH.value.number_of_members =
            reportStore.reportDataDH.six[props.sixId].number_of_members;
          sixPanelDataDH.value.links = reportStore.reportDataDH.six[props.sixId].links;
        }
        if (reportStore.reportDataCH.six[props.sixId]) {
          sixPanelDataCH.value.comment =
            reportStore.reportDataCH.six[props.sixId].comment;
          sixPanelDataCH.value.number_of_members =
            reportStore.reportDataCH.six[props.sixId].number_of_members;
      ...
      if (
        reportStore.reportReject.six[props.sixId] &&
        reportStore.isReportReject.six[props.sixId]
      ) {
        reportStore.returnReport.six[props.sixId] = true;
      }
      ...
      if (props.isDistrictHeadquarterCommander || props.isCentralHeadquarterCommander) {
        ...
        if (reportStore.reportDataDH.ninth[props.ninthId]) {
          ninthPanelDataDH.value.comment =
            reportStore.reportDataDH.ninth[props.ninthId].comment;
          ninthPanelDataDH.value.event_happened =
            reportStore.reportDataDH.ninth[props.ninthId].event_happened;
          ninthPanelDataDH.value.links =
            reportStore.reportDataDH.ninth[props.ninthId].links;
        }
        if (reportStore.reportDataCH.ninth[props.ninthId]) {
          ninthPanelDataCH.value.comment =
            reportStore.reportDataCH.ninth[props.ninthId].comment;
          ninthPanelDataCH.value.event_happened =
            reportStore.reportDataCH.ninth[props.ninthId].event_happened;
          ninthPanelDataCH.value.links =
            reportStore.reportDataCH.ninth[props.ninthId].links;
        }
      } else {
        if (Object.keys(props.data).length > 0) {
          ...
          if (props.tab == "Доработка") {
            ...
            ninthPanelDataDH.value.document =
              reportStore.reportDataDH.ninth[props.ninthId].document;
            ninthPanelDataCH.value.comment =
              reportStore.reportDataCH.ninth[props.ninthId]?.comment;
            ninthPanelDataCH.value.event_happened =
              reportStore.reportDataCH.ninth[props.ninthId].event_happened;
            ninthPanelDataCH.value.document =
              reportStore.reportDataCH.ninth[props.ninthId].document;
            ninthPanelDataCH.value.links =
              reportStore.reportDataCH.ninth[props.ninthId].links;
          }
          if (!ninthPanelData.value.links.length) {
      ...
      if (props.isDistrictHeadquarterCommander) {
        if (reportStore.reportDataDHFile.ninth[props.ninthId]) {
          ...
          fileDH.value.type = reportStore.reportDataDHFile.ninth[props.ninthId].type
            .split("/")
            .at(-1);
          fileDH.value.size =
            reportStore.reportDataDHFile.ninth[props.ninthId].size / Math.pow(1024, 2);
        }
      } else if (props.isCentralHeadquarterCommander) {
        if (reportStore.reportDataDH.ninth[props.ninthId]) {
        ...
        if (reportStore.reportForCheckCH.ninth[props.ninthId].verified_by_chq === true) {
          ...
          reportStore.reportForCheckCH.ninth[props.ninthId].rejecting_reasons &&
          !reportStore.reportDataCHFile.ninth[props.ninthId]
        ) {
          fileCH.value.name =
            reportStore.reportForCheckCH.ninth[props.ninthId].central_version.document ||
            "";
          fileCH.value.type =
            reportStore.reportForCheckCH.ninth[props.ninthId].central_version.file_type ||
            "";
          fileCH.value.size =
            reportStore.reportForCheckCH.ninth[props.ninthId].central_version.file_size ||
            "";
          ...
          fileCH.value.type = reportStore.reportDataCHFile.ninth[props.ninthId].type
            .split("/")
            .at(-1);
          fileCH.value.size =
            reportStore.reportDataCHFile.ninth[props.ninthId].size / Math.pow(1024, 2);
        }
      }
      if (
        reportStore.reportReject.ninth[props.ninthId] &&
        reportStore.isReportReject.ninth[props.ninthId]
      ) {
        reportStore.returnReport.ninth[props.ninthId] = true;
      }
...
watch(sixPanelDataCH.value, () => {
  if (props.isCentralHeadquarterCommander) {
    ...
    if (reportStore.returnReport.six[props.sixId])
      formData.append("reasons[comment]", sixPanelDataCH.value.comment);
    emit("formDataCH", formData);
  }
});
...
watch(ninthPanelDataDH.value, (newValue) => {
  if (props.isDistrictHeadquarterCommander) {
    ...
    if (reportStore.returnReport.ninth[props.ninthId])
      formData.append("reasons[comment]", ninthPanelDataCH.value.comment);

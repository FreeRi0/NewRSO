<template>
    <v-card-text class="panel-card-text">
        <v-tabs-window v-if="!(props.centralHeadquarterCommander || props.districtHeadquarterCommander)">
                ...
                <v-tabs-window>
                    <div v-if="props.panel_number == 7" class="form__field-group">
                        ...
                        <div class="report__fieldset report__fieldset--right-block">
                            ...
                            <InputReport v-if="!seventhPanelData.scan_file" isFile type="file"
                                accept=".jpg, .jpeg, .png, .pdf" id="scan_file" name="scan_file" width="100%"
                                height="auto" @change="uploadFile" :disabled="props.centralHeadquarterCommander || props.districtHeadquarterCommander" />
                            <div v-else class="report__file-box">
                                <span class="report__file-name">
                                    <SvgIcon v-if="seventhPanelData.file_type === 'jpg'" icon-name="file-jpg" />
                                    <SvgIcon v-if="seventhPanelData.file_type === 'pdf'" icon-name="file-pdf" />
                        ...
                        <div class="form__field">
                            ...
                            <div class="form__wrapper" v-for="(item, index) in seventhPanelData.links" :key="index">
                                <InputReport @focusout="focusOut" name="14"
                                    ...
                                    v-model:value="item.link" :disabled="props.centralHeadquarterCommander || props.districtHeadquarterCommander" class="form__input mb-2" />
                        ...
                        <div class="d-flex gc-4">
                            <div class="form__field">
                                <label class="form__label" for="14">Дата <sup class="valid-red">*</sup></label>
                                <InputReport @focusout="focusOut" v-model:value="seventhPanelData.comment" id="14"
                                    name="14" class="form__input" type="date" />
                            </div>
                            <div class="form__field">
                                <label class="form__label" for="14">Место проведения<sup
                                        class="valid-red">*</sup></label>
                                <InputReport placeholder="Укажите место проведения мероприятия" @focusout="focusOut"
                                    v-model:value="seventhPanelData.comment" :disabled="props.centralHeadquarterCommander || props.districtHeadquarterCommander" id="14" name="14" class="form__input"
                                    style="width: 100%" />
                            </div>
                        </div>
                        <div class="form__field">
                            <label class="form__label" for="14">Комментарий <sup class="valid-red">*</sup></label>
                            <InputReport @focusout="focusOut" :disabled="props.centralHeadquarterCommander || props.districtHeadquarterCommander" placeholder="Напишите сообщение"
                                v-model:value="seventhPanelData.comment" id="14" name="14" class="form__input"
                                style="width: 100%" />
                        </div>
                        <div>
                    ...
                    <div v-else-if="props.panel_number == 6" class="form__field-group">
                        ...
                        <div class="form__field places">
                            ...
                            <InputReport @focusout="focusOut" v-model:value="sixPanelData.number_of_members"
                                placeholder="Введите число" id="15" name="14" :disabled="props.centralHeadquarterCommander || props.districtHeadquarterCommander" class="form__input number_input"
                                type="number" />
                        </div>
                        <div class="form__field">
                            <label class="form__label" for="14">Ссылка на социальные сети/ электронные
                            ...
                            <div class="form__wrapper" v-for="(item, index) in sixPanelData.links" :key="index">
                                <InputReport placeholder="Введите ссылку, например, https://vk.com/cco_monolit"
                                    @focusout="focusOut" :disabled="props.centralHeadquarterCommander || props.districtHeadquarterCommander" name="14" v-model:value="item.link" class="form__input mb-2" />
                        ...
                        <div class="form__field">
                            <label class="form__label" for="14">Комментарий <sup class="valid-red">*</sup></label>
                            <InputReport @focusout="focusOut" :disabled="props.centralHeadquarterCommander || props.districtHeadquarterCommander" v-model:value="sixPanelData.comment"
...
const props = defineProps({
    ...
    isSecondTab: Boolean,
    id: String,
    districtHeadquarterCommander: Boolean,
    centralHeadquarterCommander: Boolean,
});

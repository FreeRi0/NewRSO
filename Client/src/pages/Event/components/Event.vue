        ...
        <div class="container">
            ...
            <div class="wrap">
                <div class="wrap__item">
                    ...
                    <div class="event-cols-2" v-if="
                        eventsStore.event.conference_link !== null &&
                        eventsStore.event.conference_link.length > 0
                    ">
                        <SvgIcon icon-name="link-ref" class="mr-3 event-cols-2_ref" />
            ...
            <section class="section_wrap" v-else-if="
                picked === false &&
                ...
                <ul class="list_wrap" v-if="eventsStore.applications.length">
                    <li v-for="participant in eventsStore.applications.slice(
                        ...
                        <router-link :to="{
                            ...
                            <div class="text text--position" v-if="participant?.position">
            ...
            <section class="section_wrap" v-else="
                    picked === false &&
                ...
                <ul v-if="eventsStore.groupApplications.length" class="list_wrap">
                    <template v-for="participant in eventsStore.groupApplications">
                        <li v-for="item in participant.applicants.slice(0, 6)" :key="item">
                            <router-link :to="{
                                name: 'userpage',

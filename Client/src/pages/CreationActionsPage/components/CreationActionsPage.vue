                        ...
                        <div class="form__field-group">
                            <div class="form-container">
                                <div class="form-col-100">
                                    <label class="form__label"
                                        >Выберите формат мероприятия</label
                                    >
                                    <div
                                        style="
                                            display: flex;
                            ...
                            <div class="form-container">
                                ...
                                >
                                    ...
                                    <sortByEducation
                                        v-model="
                                            maininfo.available_structural_units
                                        "
    ...
    switch (maininfo.value.application_type) {
        ...
        case 'Групповая':
            if (roles.roles.value?.centralheadquarter_commander) {
                ...
                area_massive.value = [{ name: 'Отряды' }];
            }
            break;
        case 'Многоэтапная':
            area_massive.value = [
            ...
            selectedUser.value.forEach((item) => {
                if (item.is_organizer) {
                    patchOrganizator(
                        ...
                        resp.data.organization_data[0].id,
                    );
                } else {

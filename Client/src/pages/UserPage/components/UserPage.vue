<template>
    <div class="container">
        <div class="user-wrapper" v-if="!isLoading.isLoading.value">
            ...
            <div class="mt-14" v-if="user.user.value.is_verified || (user.user.value.privacy?.privacy_about === 'detachment_members' && user.user.value.detachment_id === currentUser.currentUser.value.detachment_id || user.user.value.privacy?.privacy_about === 'management_members' && (roles.roles.value.detachment_commander === squad.squad.value.id || roles.roles.value.regionalheadquarter_commander === regionalHeadquarter.regional.value.id ||  roles.roles.value.localheadquarter_commander || roles.roles.value.educationalheadquarter_commander || roles.roles.value.districtheadquarter_commander || roles.roles.value.centralheadquarter_commander) || user.user.value.privacy?.privacy_about === 'all' && user.user.value )">
                {{ user.user.value.bio }}
            </div>
            <div class="mt-8 photoWrapper"  v-if="user.user.value.privacy?.privacy_photo === 'detachment_members' && user.user.value.detachment_id === currentUser.currentUser.value.detachment_id || user.user.value.privacy?.privacy_photo === 'management_members' && (roles.roles.value.detachment_commander === squad.squad.value.id || roles.roles.value.regionalheadquarter_commander === regionalHeadquarter.regional.value.id ||  roles.roles.value.localheadquarter_commander || roles.roles.value.educationalheadquarter_commander || roles.roles.value.districtheadquarter_commander || roles.roles.value.centralheadquarter_commander) || user.user.value.privacy?.privacy_photo === 'all' && user.user.value">
                <userPhoto
                    class="photo-item"

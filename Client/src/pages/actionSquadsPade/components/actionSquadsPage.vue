                ...
                <div class="cardClock">
                  <div>
                    ...
                    >
                      ...
                      />
                      <path
                        d="M10 11.6641L10 9.16406"
                        stroke="#35383F"
                        stroke-linecap="round"
                      />
                      <path
                        d="M14.583 6.25L15.833 5"
                        stroke="#35383F"
                        stroke-linecap="round"
                      />
                      <path
                  ...
                  <div>
                    <p>
                      {{
                        dateHandler(
                          variant.time_data.registration_end_date,
                          variant.time_data.registration_end_time
                        )
                      }}
                    </p>
                  </div>
...
const dateHandler = (date, time) => {
  if (date) {
    if (Date.parse(date + "T" + time) < Date.parse(new Date())) {
      ...
      return years > 0
        ? `Окончание регистрации через ${years} ${plural(years, y)}`
        : months > 0
        ? `Окончание регистрации через ${months} ${plural(months, m)}`
        : days > 0
        ? `Окончание регистрации через ${days} ${plural(days, d)}`
        : hours > 0

            ...
            <v-expansion-panel value="panelTwo">
                ...
                <v-expansion-panel-text class="form__inner-content">
                    <div class="form__field-group">
                        ...
                        <div class="form__field" v-if="participantsHQ">
                            <p>
                                Участники отряда
                                <sup class="valid-red">*</sup>
                            </p>
...
// const input = ref(
//     document.querySelector('.p-dropdown-filter.p-inputtext.p-component'),
// );

// console.log(input);

// const inputWhite = computed(() => {
//     if (input.value.lenth > 0) {

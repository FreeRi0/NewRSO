  ...
  <form class="form" enctype="multipart/form-data" @submit.prevent="changeHeadquarter">
    <v-expansion-panels v-model="panel">
      <v-expansion-panel value="panelOne">
        <v-expansion-panel-title>
          <template v-slot="{ expanded }">
            <v-row no-gutters>
              <v-col cols="4" class="d-flex justify-start"> Основная информация </v-col>
          ...
          <div class="form__field-group">
            <div class="form__field">
              ...
              <Input
                ...
                :maxlength="100"
              />
              <div class="form__counter">{{ counterTitle }} / 100</div>
            </div>
            <div class="form__field">
            ...
            <div class="form__field">
              <label class="form__label" for="create-date">Дата основания </label>
              <!-- <input
                                id="create-date"
            ...
            <div class="form__field">
              <label class="form__label" for="select-regional-office"
      ...
      <v-expansion-panel value="panelTwo">
        <v-expansion-panel-title>
          <v-row no-gutters>
            <v-col cols="4" class="d-flex justify-start"> Контакты </v-col>
          </v-row>
          <template v-slot:actions="{ expanded }">
            <v-icon v-if="!expanded">
              <svg
      ...
      <v-expansion-panel value="panelThree">
        <v-expansion-panel-title>
          <v-row no-gutters>
            <v-col cols="4" class="d-flex justify-start"> Оформление </v-col>
          </v-row>
          <template v-slot:actions="{ expanded }">
            <v-icon v-if="!expanded">
              <svg
          ...
          <div class="form__field-group">
            <div class="form__field">
              ...
              <Input
                ...
                :maxlength="100"
              />
              <div class="form__counter">{{ counterSlogan }} / 100</div>
            </div>
            <div class="form__field">
              ...
              ></TextareaAbout>
              <div class="form__counter">{{ counterAbout }} / 500</div>
            </div>
            ...
            <div class="form__field photo-add">
              ...
              <span class="form-field__footnote">Рекомендуемый размер 80х80</span>
            </div>
            ...
            <div class="form__field photo-add">
              ...
              <div class="photo-add__box photo-add__box--banner">
                ...
                <div class="photo-add__input">
                  <label class="photo-add__label" for="upload-banner" v-show="!urlBanner">
                    <svg
                      class=""
                      aria-hidden="true"
                      focusable="false"
                  ...
                  <input
                    ...
                    @change="selectBanner"
                  />
                  <div class="photo-add__edit-group" v-show="urlBanner">
              ...
              <span class="form-field__footnote">Рекомендуемый размер 1920х768</span>
            </div>
          </div>
        </v-expansion-panel-text>
      </v-expansion-panel>
...
const emit = defineEmits(["update:value", "changeHeadquarter"]);
...
const sortedMembers = computed(() => {
  return members.value.filter((item) => {
    // return item.title
    return item.user.last_name.toUpperCase().includes(searchMembers.value.toUpperCase());
  });
});

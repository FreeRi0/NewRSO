        ...
        <v-expansion-panels v-model="panel">
                ...
                <v-expansion-panel-text class="form__inner-content">
                    <div class="form__field-group">
                        <div class="form__field">
                            <label class="form__label" for="name-hq">Наименование штаба
                                <sup class="valid-red">*</sup>
                            </label>
                            <Input id="name-hq" class="form__input form__input-bc"
                                placeholder="Например, Штаб СО Алтайского государственного медицинского университета (Штаб СО АГМУ)"
                                name="name_hq" v-model:value="headquarter.name" :maxlength="100" />
                        ...
                        <div class="form__field">
                            ...
                            <educInstitutionDropdown open-on-clear id="select-institution" name="select_institution"
                                placeholder="Например, Алтайский государственный медицинский университет"
                                v-model="headquarter.educational_institution" @update:value="changeValue"
                                :SortDropdown="false">
                            </educInstitutionDropdown>
                            <p class="form__error" v-if="isError.educational_institution">
                        ...
                        <div class="form__field">
                            ...
                            <Input class="form__input form__input-bc" id="create-date" name="create_date" type="date"
                        ...
                        <div class="form__field">
                            <label class="form__label" for="select-regional-office">Выберите региональное отделение
                                <sup class="valid-red">*</sup>
                            </label>
                            <SearchSelect :items="regionalsStore.regionals" open-on-clear id="select-regional-office"
                                name="select_regional-office"
                                placeholder="Например, Карачаево-Черкесское региональное отделение"
                                v-model="headquarter.regional_headquarter" @update:value="changeValue"></SearchSelect>
                            <p class="form__error" v-if="isError.regional_headquarter">
                        ...
                        <div class="form__field">
                            ...
                            <Input class="form__input form__input-bc" id="city" placeholder="Например, Москва"
                                name="edit_city" v-model:value="headquarter.city" />
                        </div>

                        <div class="form__field form__field--commander">
                            <label class="form__label" for="beast">Командир штаба СО ОО:
                                <sup class="valid-red">*</sup>
                            </label>
                            <Dropdown v-if="!isCommanderLoading" open-on-clear id="beast" name="edit_beast"
                                placeholder="Поиск по ФИО" :is-reg="false" v-model="headquarter.commander"
                                @update:value="changeValue" :head-val="regionalsStore.regionals.find(
                                    (item) =>
                                        item.id ==
            ...
            <v-expansion-panel value="panelTwo">
                ...
                <v-expansion-panel-text class="form__inner-content">
                    <div class="form__field-group">
                        <div class="form__field">
                            <label class="form__label" for="social-media-vk">Группа штаба ВКонтакте
                            </label>
                            <TextareaAbout maxlength="50" class="form__textarea form__textarea--mobile form__input-bc"
                        ...
                        <div class="form__field">
                            <label class="form__label" for="social-media-te">Группа штаба в Телеграм
                            </label>
                            <TextareaAbout maxlength="50" class="form__textarea form__textarea--mobile form__input-bc"
                        ...
                        <div class="form__field" v-if="participants">
                            ...
                            <v-text-field class="form__field-search" variant="outlined" type="text"
                                placeholder="Поиск по ФИО" @keyup="searchMemberHQ" v-model="searchMembers">
                            ...
                            <MembersList :items="props.members" :submited="submited"
            ...
            <v-expansion-panel value="panelThree">
                ...
                <v-expansion-panel-text class="form__inner-content">
                    <div class="form__field-group">
                        <div class="form__field">
                            <label class="form__label" for="hq-slogan">Девиз штаба</label>
                            <TextareaAbout maxlength="100" class="form__textarea form__textarea--mobile form__input-bc"
                                id="hq-slogan" placeholder="Например, через тернии к звездам" name="hq_slogan"
                        ...
                        <div class="form__field">
                            <label class="form__label" for="about-hq">О штабе</label>
                            <TextareaAbout :rows="6" maxlength="500" class="form__textarea form__input-bc" id="about-hq"
                                placeholder="Расскажите о штабе" name="about_hq" v-model:value="headquarter.about">
                            </TextareaAbout>
                            <div class="form__counter">
                                {{ counterAbout }} / 500
                            </div>
